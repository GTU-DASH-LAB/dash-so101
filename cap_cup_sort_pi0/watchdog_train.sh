#!/usr/bin/env bash
# ============================================================================
# Watchdog for pi0 LoRA fine-tuning: if lerobot-train dies (OOM, crash, etc.)
# before reaching STEPS, automatically clean up and resume from the last
# checkpoint instead of losing the rest of an unattended run. Worth using
# here even more than ball_pickup_pi0 -- this run is ~24h.
#
# Usage:
